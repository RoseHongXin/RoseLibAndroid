...
public class DMenuBU extends DialogFragment{
    ...
    private class VhItem extends VhBase<String>{
        ...
        public void bind(String data, int position) {
            ...
            itemView.findViewById(R.id._v_menuItemDivider).setVisibility(position == 0 ? View.GONE : View.VISIBLE);
            ((TextView)itemView.findViewById(R.id._tv_menuItem)).setText(data);
            itemView.findViewById(R.id._tv_menuItem).setOnClickListener(v -> {
