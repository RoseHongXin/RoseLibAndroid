...
//        if (!isEnabled() || mContent == null || mHeaderView == null) {return super.dispatchTouchEvent(e);}
...
//
////                if(Math.abs(offsetY) < mPagingTouchSlop) return super.dispatchTouchEvent(e);
//
...
//                            offsetY, mPtrIndicator.getCurrentPosY(), moveUp, canMoveUp, moveDown, canMoveDown, canHeaderMoveDown, canFooterMoveUp);
//                }
//
...
//                        PtrCLog.v(LOG_TAG, "content scroll down");
////                        return super.onInterceptTouchEvent(e);
//                        return super.dispatchTouchEvent(e);
////                        return true;
//                    }
//                    if (moveUp && !canFooterMoveUp) {
//                        PtrCLog.v(LOG_TAG, "content scroll up");
////                        return super.onInterceptTouchEvent(e);
//                        return super.dispatchTouchEvent(e);
////                        return true;
//                    }
...
//                float offsetX = mPtrIndicator.getOffsetX();
//                float offsetY = mPtrIndicator.getOffsetY();
//                if(Math.abs(offsetY) > mPagingTouchSlop) return true;
//        }
//        return super.dispatchTouchEvent(e);
//    }
    @Override
...
//                mPreventForHorizontal = false;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                float offsetX = mPtrIndicator.getOffsetX();
                float offsetY = mPtrIndicator.getOffsetY();
//                if(mContent.canScrollVertically((int)offsetY) && ((offsetY < 0 && mContent.getScrollY() == 0) || (offsetY > 0 && mContent.getScrollY() == mContent.getHeight()))) {return super.onInterceptTouchEvent(e);}
//                if(mContent.canScrollVertically((int)offsetY)) { return super.onInterceptTouchEvent(e);}
                if(Math.abs(offsetY) > mPagingTouchSlop) return true;
//                if(!mContent.canScrollVertically((int)offsetY) && Math.abs(offsetY) > mPagingTouchSlop) return true;
        }
        return super.onInterceptTouchEvent(e);
    }
...
//                    if (mPtrIndicator.isInStartPosition()) {mPreventForHorizontal = true;}
//                }
