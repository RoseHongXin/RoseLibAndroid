...
//        mPagingTouchSlop = conf.getScaledTouchSlop() * 2;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContent != null) {
            ...
            if (DEBUG && DEBUG_LAYOUT) {
                PtrCLog.d(LOG_TAG, "onMeasure target, width: %s, height: %s, margin: %s %s %s %s",
                        getMeasuredWidth(), getMeasuredHeight(),
...
//                    }
//                }
//                if (mPreventForHorizontal) {return dispatchTouchEventSupper(e);}
...
//                }
                ...
                if (!canMoveUp && !canMoveDown) {
                    ...
                    if (moveDown && !canHeaderMoveDown) {return super.onTouchEvent(e);}
                    if (moveUp && !canFooterMoveUp) {return super.onTouchEvent(e);}
