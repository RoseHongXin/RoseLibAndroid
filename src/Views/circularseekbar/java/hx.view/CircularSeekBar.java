...
public class CircularSeekBar extends View {
    ...
    /**
     * Minimum touch anchor size in DP. 48dp is the Android design recommendation
     */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        float minimumTouchTarget = MIN_TOUCH_TARGET_DP * DPTOPX_SCALE; // Convert minimum touch anchor into px
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                break;
            case MotionEvent.ACTION_CANCEL: // Used when the target view intercepts touches for things like scrolling
                mPointerHaloPaint.setAlpha(mPointerAlpha);
                mPointerHaloPaint.setColor(mPointerHaloColor);
                mUserIsMovingPointer = false;
                invalidate();
