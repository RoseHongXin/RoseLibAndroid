...
public class Swipe2DeleteRecyclerView extends RecyclerView {
    ...
    private ViewHolder mTouchView;
    private OnSwipeListener mOnSwipeListener;

    private Interpolator mCloseInterpolator;
    private Interpolator mOpenInterpolator;

    public Swipe2DeleteRecyclerView(Context context) {
        super(context);
        init();
    }

    public Swipe2DeleteRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public Swipe2DeleteRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
